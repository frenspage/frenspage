...
export default class Postits<IPostits> {
    ...
    public size():number            { return this._postitList.length;  }
    public get(i:number):IPostit    { return this._postitList[i]; }
    public getPostitList()         { return this._postitList; }
    public setPostitList(pPostitList:TPostitList) { this._postitList = pPostitList; }

    public add(postit:IPostit) {
        this._postitList = [...this._postitList, postit];
    }
