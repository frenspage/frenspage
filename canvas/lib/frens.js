...
const appId = "A8feK7vDAT4yK3K4a62KVbQzvXDHqzuNNgFr4hsz";
const serverUrl = 'https://kt6hbt4jtxsv.usemoralis.com:2053/server'

Moralis.start({ serverUrl, appId });

/* EDIT THESE ALONG YOUR NEEDS */
//Address of the smart contract you want to check for
const secretNFTaddress = "0x495f947276749Ce646f68AC8c248420045cb7b5e"; //opensea store address
...
const defaultimg = 'https://neontools-prod-user-image.s3.eu-central-1.amazonaws.com/a1d2269dbe4b0473f8a3.jpg';
...
function abortLoad()
{
    console.log("Error: Something went wrong while loading the NFTs. Logging out.");
    //disconnect();
}
    ...
    if(showcontent)
    {
        ...
        if(token_address == ENSCONTRACTADDRESS)
        {
            ...
            var d = "<div class='nftbox'>";            
                    ...
                    d += "<div id='pfp_"+ token_address + "_" + token_id +"' class='pfpselected'>V</div>";
                    d += "<div class='ensbubble' id='ensbubble_"+ token_address + "_" + token_id + "' onclick='selectPFP(&quot;pfp_"+ token_address + "_" + token_id +"&quot;,&quot;" + token_address+"&quot;,&quot;" + token_id+"&quot;);' style='background-image:url(&quot;"+img+"&quot;);' >";
                    d += "</div>";
        ...
        else
        {
            var d = "<div class='nftbox'>";            
                    ...
                    d += "<div id='pfp_"+ token_address + "_" + token_id +"' class='pfpselected'>V</div>";
                    d += "<div class='nftbubble' id='nftbubble_"+ token_address + "_" + token_id + "' onclick='selectPFP(&quot;pfp_"+ token_address + "_" + token_id +"&quot;,&quot;" + token_address+"&quot;,&quot;" + token_id+"&quot;);' style='background-image:url(&quot;"+img+"&quot;);' >";
                    d += "</div>";
                    d += "<div class='nftname'>"+name+"</div>";
...
{
    cansavepfp = true;
    $(".profilepicselect").css("background-image",$("#nftbubble_"+ selectedPFP["token_address"] + "_" + selectedPFP["token_id"]).css("background-image"));
...
async function savePFP(){
    ...
    if(cansavepfp){    
        ...
        pfp.save()
        .then((pfp) => {
            image = $("#nftbubble_"+ selectedPFP["token_address"] + "_" + selectedPFP["token_id"]).css("background-image");
            setPFPs(image);
...
function chooseENS()
{
    newusername = $("#ensname_"+ selectedENS["token_address"] + "_" + selectedENS["token_id"]).html();
    cansaveens = true;
...
function checkSecretNFT(contractaddress,tokenid)
{
    ...
    if(secretTokenID == "")
    {
        if(contractaddress.toLowerCase() == secretNFTaddress.toLowerCase())
        {
            hasSecret();
        }
    }
    else if(Array.isArray(secretTokenID))
    {
        ...
        {  
            if(contractaddress.toLowerCase() == secretNFTaddress.toLowerCase() && val == tokenid)
            {
                hasSecret();
            }
        });
        ...
        if(contractaddress.toLowerCase() == secretNFTaddress.toLowerCase() && tokenid == secretTokenID)
        {
            hasSecret();
        }
    }
    ...
    if(!hooked)
    {
        ...
        .done(function( data ) {
            ...
            if(addethaddress)
            {
                ...
                $("#nextbutton").attr("href",link + "?ethaddress="+user.ethAddress);
            }
...
function openENSSelect()
{
    ...
    token_id = "25222095590874728349755125166335892413298380980240991954037623438333759328804";
    ensname = "Mitchoz.eth";
    img = "https://lh3.googleusercontent.com/OsUWP7Pe9nzHknJfMbXSaTJiIZE7qMvJ1MwwJMZ_Qm26k9_hkk9FJ7YYvh6up0NXDoFiPvOIdUuo0qOHW95aUpnmSFxa1k70iQsJ=w600";

    var d = "<div class='nftbox'>";            
            
            d += "<div id='ens_"+ token_address + "_" + token_id + "' class='ensselected'>V</div>";
            d += "<div class='ensbubble' id='ensbubble_"+ token_address + "_" + token_id + "' onclick='selectENS(&quot;ens_"+ token_address + "_" + token_id +"&quot;,&quot;" + token_address+"&quot;,&quot;" + token_id+"&quot;);' style='background-image:url(&quot;"+img+"&quot;);' >";
            d += "</div>";
            d += "<div class='ensname' id='ensname_"+ token_address + "_" + token_id +"'>"+ensname+"</div>";
...
async function disconnect()
{
    localStorage.clear();
    user = null;
    Moralis.User.logOut().then(function(){window.location.reload();});
